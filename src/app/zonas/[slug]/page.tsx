...
export default async function ZonaPage({ params }: Props) {
  ...
  const waMsg = encodeURIComponent(`Hola Openagua, necesito una destapación en ${zona.name}. ¿Pueden ayudarme?`);
    ...
    <main className="zona-page">
      <header className="zona-hero">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          ...
          <a href={waUrl} target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ padding: '1rem 2.5rem', fontSize: '1.1rem' }}>
