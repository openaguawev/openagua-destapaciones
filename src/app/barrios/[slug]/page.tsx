...
export default async function BarrioPage({ params }: Props) {
  ...
  const waMsg = encodeURIComponent(`Hola Openagua, necesito una destapación en ${barrio.name}. ¿Pueden ayudarme?`);
      ...
      <main className="barrio-page">
        ...
        >
          ...
          <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
            ...
            <a href={waUrl} target="_blank" rel="noopener noreferrer" className="btn-primary hero-whatsapp-btn" style={{ padding: '1.1rem 3rem', fontSize: '1.25rem', boxShadow: '0 10px 25px -5px rgba(22, 163, 74, 0.5)', transition: 'transform 0.2s', display: 'inline-flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div className="container" style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
              ...
              <div style={{ backgroundColor: '#ffffff', padding: '3rem', borderRadius: '16px', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)', border: '1px solid #e2e8f0' }}>
                ...
                <a href={waUrl} target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center', marginTop: '3rem', backgroundColor: '#0f172a', color: 'white', padding: '1rem', borderRadius: '8px', fontWeight: 'bold', textDecoration: 'none' }}>
                  Pedir Máquina Hoy
                </a>
              </div>
            </div>
        ...
        <section className="section" style={{ padding: '6rem 0', backgroundColor: '#ffffff' }}>
          <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '5rem' }}>
              ...
              <a href={waUrl} target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ padding: '1.25rem 3.5rem', fontSize: '1.2rem', boxShadow: '0 10px 25px -5px rgba(22, 163, 74, 0.5)' }}>
