...
export default function Resenas() {
  const reviews = [
    { text: "Los contacté por una cañería tapada, vinieron rápido (era feriado), en el tiempo que dijeron. Cobran lo pactado, buen precio, excelente trabajo.", author: "Carolina Fernandez", rating: 5 },
