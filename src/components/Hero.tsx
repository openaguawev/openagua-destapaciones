    ...
    <section className="hero-section">
      ...
      <div className="container hero-content">
        ...
        <div className="hero-ctas">
          <a href="https://wa.me/5491151797649?text=Hola%20Openagua%2C%20quiero%20consultar%20por%20un%20presupuesto" target="_blank" rel="noopener noreferrer" className="btn-primary hero-btn">
          ...
          <a href="tel:+5491151797649" className="btn-outline hero-btn" style={{ backgroundColor: '#1D4ED8', borderColor: '#1D4ED8', color: '#ffffff' }}>
            <span className="icon" style={{ display: 'flex' }}>
