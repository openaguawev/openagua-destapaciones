...
export const getArticulos = (): Articulo[] => {
  return [
    ...
    },
    {
      ...
      content: `
        ...
        ${getFaqHtml([
          ...
          {q: "¿Openagua cubre mantenimientos urgentes con equipos hidrojet grandes en el GBA?", a: "De hecho, contamos con nuestro vehículo equipado con tanques de agua propios y bombas de gran caudal motorizadas para dar respuesta inmediata resolutiva en torres de barrios residenciales o fábricas inmensas del Gran Buenos Aires."},
    ...
    },
    {
      ...
      content: `
        ...
        ${getFaqHtml([
          ...
          {q: "¿Tienen cobertura y alcance logístico en los alejados barrios cerrados y grandes countries del GBA?", a: "Efectivamente. Damos asistencia rápida, preferencial y mantenimiento programado en condominios, barrios privados perimetrados y parques industriales lejanos desde el confín de la Zona Norte hasta los extremos más apartados de la Zona Sur y el Oeste bonaerense, incluyendo lógicamente toda la densa extensión de Capital Federal con nuestro equipo para cada área geográfica."},
    ...
    },
    {
      ...
      content: `
        ...
        <p>Ahora bien, no todos los problemas se originan en los mecanismos plásticos interiores. Existen señales de alarma que te indicarán que la pérdida de tu baño requiere acción técnica inmediata. Si detectás que el charco de agua no proviene del goteo del botón, sino que hay agua filtrándose constantemente desde la base inferior del inodoro hacia las baldosas cerámicas, esto indica una falla en el sello de la brida o conexión cloacal. Ante estas <a href="/servicios/destapaciones-canerias" style="color:#16A34A;font-weight:bold;text-decoration:underline;">problemas en cañerías</a> o bases deterioradas, desenroscar el inodoro por tus propios medios puede empeorar el panorama estructural severamente.</p>
    ...
    content: `
      ...
      <p>Si sospechás que hay un daño estructural, lo mejor es usar tecnología avanzada. Nosotros realizamos inspecciones con cámara para <a href="/blog/video-inspeccion-canerias-como-funciona" style="color:#16A34A;font-weight:bold;text-decoration:underline;">detectar roturas en cañerías</a> sin tener que romper todo el baño.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Si querés leer más sobre cómo se diagnostican estas fallas, podés ver nuestro artículo sobre <a href="/blog/video-inspeccion-canerias-como-funciona" style="color:#16A34A;font-weight:bold;text-decoration:underline;">cómo saber si un caño está roto</a> de forma prolija en el hogar.</p>
