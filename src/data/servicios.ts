  ...
  return [
    buildServicio(
      ...
      [
        ...
        { q: "¿Entregan factura y garantía?", a: "Sí, emitimos factura por todos nuestros trabajos. No entregamos un certificado de garantía porque trabajamos sobre instalaciones muchas veces antiguas y el resultado también depende del uso posterior. Si el problema se complica durante el trabajo, te avisamos antes de continuar." }
      ],
      {
    ...
    buildServicio(
      ...
      [
        ...
        { q: "¿Dan garantía por el trabajo?", a: "No entregamos un certificado de garantía. Trabajamos sobre instalaciones que muchas veces son antiguas y el resultado también depende del uso posterior. Lo que sí hacemos es verificar el flujo de agua junto a vos antes de irnos y avisar si el trabajo se complica antes de continuar." },
